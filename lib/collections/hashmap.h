...
static inline bool hashmap_contains_key(HashMap map, const void* key) { return hashmap_get(map, key) != NULL; }

static inline size_t hashmap_size(HashMap map) { return map.size; }
